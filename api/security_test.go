...
func TestgetSignature(t *testing.T) {
	...
	signed, _ = getSignature(common.HttpMethodGet, "http://test.stretchr.com/api/v1?~key=ABC123&:name=!Mat&:name=!Laurie&:age=>20", []byte("body"), "ABC123-private")
	...
	signed, _ = getSignature(common.HttpMethodGet, "http://test.stretchr.com/api/v1?~key=ABC123&:name=!Mat&:name=!Laurie&:age=>20", []byte("body"), "DIFFERENT-PRIVATE")
	assert.Equal(t, "34f55c3a086c260098e75066b38ac42e33e8faab", signed)

	signed, _ = getSignature(common.HttpMethodGet, "http://test.stretchr.com/api/v1?:name=!Laurie&~key=ABC123&:age=>20&:name=!Mat", []byte("body"), "DIFFERENT-PRIVATE")
