...
func TestHash(t *testing.T) {
	...
	assert.Equal(t, "a9993e364706816aba3e25717850c26c9cd0d89d", hash(str), "MAIN Hash test")
...
func TestgetSignature(t *testing.T) {
	...
	signed, _ = getSignature(HttpMethodGet, "http://test.stretchr.com/api/v1?~key=ABC123&:name=!Mat&:name=!Laurie&:age=>20", "body", "ABC123-private")
	...
	signed, _ = getSignature(HttpMethodGet, "http://test.stretchr.com/api/v1?~key=ABC123&:name=!Mat&:name=!Laurie&:age=>20", "body", "DIFFERENT-PRIVATE")
	assert.Equal(t, "34f55c3a086c260098e75066b38ac42e33e8faab", signed)

	signed, _ = getSignature(HttpMethodGet, "http://test.stretchr.com/api/v1?:name=!Laurie&~key=ABC123&:age=>20&:name=!Mat", "body", "DIFFERENT-PRIVATE")
